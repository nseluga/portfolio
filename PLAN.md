...
- [x] Lighthouse pass: performance (verify islands don't leak JS to non-chart pages), a11y, best-practices, SEO.
...
- [x] Final commit — full site built and locally verified, ready for human hookup.
