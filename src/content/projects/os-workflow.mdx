...
section: "engineering"
date: 2026-07-09
summary: "A personal operating system built on top of Claude Code: 48 custom skills, a structured project-tracking system covering 8 active projects, and a persistent memory layer with 10 fact files. Each skill added makes the next session more capable. It's the infrastructure behind all AI-assisted work on this site."
...
3. **Compounding requires investment discipline.** The skills that pay off most are the ones where I took the time to write down the rubric carefully. That means doing the thinking upfront that I'd otherwise skip. The shortcut of writing a thin skill produces a thin result. The discipline is treating skill files like I'd treat a unit test: worth investing in once so you don't have to re-derive it.
