...
4. **The ceiling was tested, not assumed.** Log-normal AFT, ExtraSurvivalTrees, and an IPCW loss were all tried and reverted with recorded numbers. That's how I know 0.574 is where the signal actually stops.
